...
from omc3.model.accelerators.psbooster import PsBase, Psbooster
...
class PsOrBoosterModelCreator(ModelCreator):
    acc_model_name = None
...
class BoosterModelCreator(PsOrBoosterModelCreator):
    acc_model_name = "psb"
