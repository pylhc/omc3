...
def calculate_coupling(meas_input, input_files, phase_dict, tune_dict, header_dict):
    ...
    f1001 = -0.5 * sqrt(np.abs(A01 * B10)) * 0.5 * (exp(1.0j * q1001_from_A) + exp(1.0j * q1001_from_B))
    f1010 = 0.5 * sqrt(np.abs(A0_1 * B_10)) * 0.5 * (exp(1.0j * q1010_from_A) + exp(1.0j * q1010_from_B))
