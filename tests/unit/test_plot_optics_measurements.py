...
def test_orbit_ip_positions_location(tmp_output_dir):
    _default_test("orbit", x_axis="location", ip_positions="LHCB1", output_dir=tmp_output_dir)
...
def test_orbit_ip_positions_phase(tmp_output_dir):
    with pytest.raises(NotImplementedError):  # remove once implemented
        _default_test(
            "orbit", x_axis="phase-advance", ip_positions="LHCB1", output_dir=tmp_output_dir
        )
